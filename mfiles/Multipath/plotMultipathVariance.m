...
[sigma_L,sigmad,sigmas]  = getFPStdDev(L,h1,h2,sigmah,lambda);

hh1 = figure;
plot(L/1000,sigma_L,'LineWidth',2)
hold on
plot(L/1000,sigmad,'LineWidth',2)
grid on
xlim([4 20])
...
[sigma_a,sigmad,sigmas] = getFPStdDev(L,h1,h2,sigmah,lambda);

hh2 = figure;
plot(h2,sigma_a,'LineWidth',2)
hold on
plot(h2,sigmad,'LineWidth',2)
grid on
xlim([2 20])
xlabel('Altitude (m)')
ylabel('F_p Std. Dev.');
