...
\noindent This gives us an equation dependent only on the amplitude, $A$
 ...
 \begin{equation}
-2jk_f\frac{\partial A}{\partial x}+\frac{\partial^2 A}{\partial x^2} + \frac{\partial^2 A}{\partial z^2} + k_f^2\left(n_r^2-1\right)A= 0 \\
\label{gf_eq:42}
\end{equation}
 \renewcommand{\baselinestretch}{2} \small\normalsize
...
\begin{equation}
\begin{aligned}
\hat{G_p}&=c\exp\left[-\frac{k^2 - k_f^2(n_r^2-1)}{2jk_f} \right]\\
&= c\exp\left[\frac{jk^2}{2k_f}x \right] \exp\left[-\frac{jk_f(n_r^2-1)}{2}x\right]
\end{aligned}
\label{gf_eq:46}
\end{equation}
 \renewcommand{\baselinestretch}{2} \small\normalsize
...
\lim_{x\rightarrow 0}2jk_fc\exp\left[\frac{jk^2}{2k_f}x\right]\exp\left[\frac{-jk_f(n_r^2-1)}{2}x\right] = 1\\
c = \frac{1}{j2k_f}\\
\end{gathered}
\label{gf_eq:11cb}
\end{equation}
...
\begin{table}[ht]
  ...
  2-D Paraxial & $\displaystyle\sqrt{\frac{1}{8\pi jk_f|x-x'|}}\exp\left[-jk_f\left(|x-x'|\left[1+\frac{m}{2}\right] + \frac{|z-z'|^2}{2|x-x'|}\right)\right]$\\[7.5pt] \hline
  2-D PWE &$\displaystyle\sqrt{\frac{1}{8\pi jk_f|x-x'|}}\exp\left[-jk_f\left(|x-x'|\left[1+\frac{m_z}{2}\right] + \frac{|z-z'|^2}{2|x-x'|}\right) \right]$ \\[7.5pt] \hline
\end{tabular}
