...
As we will see shortly, this choice of time dependence drives the sign of the spatial phase dependence for a forward propagating wave and defines the forward and reverse Fourier transforms.
...
This convention means that we can interpret the transform back to the time domain as an integral of the signal of interest scaled by forward propagating waves. With this definition, we can compute the Green's function in the time domain:
