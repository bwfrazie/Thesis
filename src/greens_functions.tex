...
This section discusses the use of Green's functions to describe propagating over the earth with an assumption that the surface is flat.
...
\begin{equation}
F_p = \frac{1}{\sqrt{L_1}} e^{-jk_oL_1}+\Gamma_1\sqrt{\frac{L_1}{L_m}} e^{-jk_oL_m} \sum_{l=-\infty}^{\infty}J_l(\sigma)e^{j\phi_l}
\label{cyl_eq:13}
\end{equation}
\renewcommand{\baselinestretch}{2} \small\normalsize
