...
\lstinputlisting[language=Matlab,caption=1-D Ocean Surface Generation Matlab Code,label=list:elf1d]{../mfiles/SeaSurfaceGeneration/generateSeaSurface.m}

\lstinputlisting[language=Matlab,caption=Elfouhaily 2-D Spectrum Matlab Code,label=list:elf1d]{../mfiles/SeaSurfaceGeneration/Elfouhaily2D.m}

\lstinputlisting[language=Matlab,caption=2-D Ocean Surface Generation Matlab Code,label=list:elf1d]{../mfiles/SeaSurfaceGeneration/generateSeaSurface2D.m}