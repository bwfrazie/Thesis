...
\begin{equation}
\label{os_eq:10}
\mathbf{A}(m,n) = \frac{1}{4}\sqrt{Psi(m+1,n+1)\Delta k^2}\left[W_1(m,n) + iW_2(m,n) \right]
\end{equation}

\begin{equation}
\label{os_eq:11}
\mathbf{B}(m,n) = \frac{1}{4}\sqrt{\Psi(m+ 1,n+\frac{N}{2} +1)\Delta k^2}\left[W_1(m,n) + iW_2(m,n) \right]
\end{equation}
