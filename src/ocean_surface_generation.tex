...
\iftoggle{separate_ocean_surface}{\chapter{Introduction}}{\chapter{Ocean Surface Modeling}}
...
\iftoggle{separate_ocean_surface}{\chapter}{\section} {Waves in the Ocean}
...
\iftoggle{separate_ocean_surface}{\chapter}{\section}{Ocean Wave Power Spectra}  \label{os_sec:power_spectra}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {Sea State}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {Pierson-Moskowitz Spectrum}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {Bretschneider Spectrum}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {JONSWAP Spectrum}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {Elfouhaily Spectrum}
...
\iftoggle{separate_ocean_surface}{\subsection}{\subsubsection} {Spectrum Definition}
...
\iftoggle{separate_ocean_surface}{\subsection}{\subsubsection}{1-Dimensional Spectrum Visualization}
...
\iftoggle{separate_ocean_surface}{\subsection}{\subsubsection} {Comparison with PM Spectrum}
...
\iftoggle{separate_ocean_surface}{\subsection}{\subsubsection}{Directional Spreading Functions}
...
\iftoggle{separate_ocean_surface}{\subsection}{\subsubsection}{2-Dimensional Spectrum Visualization}
...
\iftoggle{separate_ocean_surface}{\chapter}{\section}{Sampling Constraints}\label{os_label:1d_sampling_constraints}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection}{Spatial Domain Constraints}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {Constraints on the Number of Points}
...
\iftoggle{separate_ocean_surface}{\chapter}{\section} {Generation of Sea Surfaces in 1-Dimension}\label{os_sec:1d}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {Frequency Domain Representation}
...
The index ordering is assumed to have $k=0$ at the first element so that the sequence will wrap in frequency at $n = \frac{N}{2} + 1$. An example sequence for $N = 8$ is shown in Table \ref{os_tab:2a}.
\begin{table}[H]
  \begin{center}
      \renewcommand{\baselinestretch}{1} \small\normalsize
  \begin{quote}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {Example Realizations}
...
\iftoggle{separate_ocean_surface}{\chapter}{\section} {Generation of Sea Surfaces in 2-Dimensions}
...
\iftoggle{separate_ocean_surface}{\chapter}{\section} {Verification}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {Verification Process}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {1-D Testing}
\iftoggle{separate_ocean_surface}{\subsection}{\subsubsection} {Ensemble Statistics}
...
\iftoggle{separate_ocean_surface}{\subsection}{\subsubsection} {Power Spectrum Recovery}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {2-D Testing}
...
\iftoggle{separate_ocean_surface}{\chapter}{\section} {Time Varying Surfaces}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {1-D Time Varying Surfaces}
...
\iftoggle{separate_ocean_surface}{\section}{\subsection} {2-D Time Varying Surfaces}

\iftoggle{separate_ocean_surface}{\chapter}{\section} {Quasi 2-D Surfaces}
