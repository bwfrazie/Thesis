...
This is a simplified approach that captures the "effect" of going through multipath peaks and nulls, but does not include cylindrical spreading of the wavefront as it propagates. A more detailed analytical approach for both the simple 2-ray model and a more complicated multiple ray model that includes cylindrical spreading is provided in Chapter\ref{analytical_propagation}.
