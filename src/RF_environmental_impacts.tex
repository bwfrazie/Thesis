...
\begin{equation}
\begin{gathered}
  \sigma^0 = c_1 + c_2 \log_{10}(\sin(\Psi))+\frac{\left(27.5 + c_3\Psi\right)\log_{10}(f)}{1+0.95\Psi}+\\
  c_4\left(1 + SS \right)^{1/\left(2+0.085\Psi + 0.033SS\right)}
 + c_5\Psi^2 
 \end{gathered}
 \label{env_eq:7a}
  \end{equation}
...
\begin{figure}[H]
  \begin{center}
\includegraphics[width=5in]{../media/multistatic/target_rcs_2_point.png}
  \end{center}
  \renewcommand{\baselinestretch}{1} \small\normalsize
  \begin{quote}
