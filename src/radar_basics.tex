...
This chapter covers some RADAR basics, including the RADAR range equation, bistatic configurations, antenna beam widths and a summary of the ideas behind probability of detection.
